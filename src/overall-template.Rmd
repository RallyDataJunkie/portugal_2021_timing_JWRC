...
if (use_group_rank) {
  ...
  multi_overall_results$position = rank(multi_overall_results$overall_position)
}
...
# Optionally, re-rank by group
if (use_group_rank) {
  multi_stage_times$overall_position = multi_stage_times$position
  multi_stage_times$position = rank(multi_stage_times$overall_position)
}
